defmodule Sacrum.DataCase do
  ...
  by setting `use Sacrum.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Sacrum.Repo, shared: not tags[:async])
