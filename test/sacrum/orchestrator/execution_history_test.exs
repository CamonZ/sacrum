defmodule Sacrum.Orchestrator.ExecutionHistoryTest do
  ...
  describe "deterministic_route_visit_count/2" do
    test "counts only completed deterministic audits for the same task and route step across runs" do
      ...
      assert ExecutionHistory.deterministic_route_visit_count(task, route.id) == 1
      ...
      assert ExecutionHistory.deterministic_route_visit_count(task, route.id) == 4
    end
